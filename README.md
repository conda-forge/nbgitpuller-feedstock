...
Once the `conda-forge` channel has been enabled, `nbgitpuller` can be installed with:

```
conda install nbgitpuller
```

It is possible to list all of the versions of `nbgitpuller` available on your platform with:
